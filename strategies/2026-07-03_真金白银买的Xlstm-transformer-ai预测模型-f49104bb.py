...
# backtestId: 607759d3a447742d39de4bc7d33632de
...
#行业ETF：
    ...
    g.enable_stop_loss_trigger = True     # 持仓ETF止损��发开关
...
def update_sector_pool(context):
    ...
    FUND_COMPANIES = sorted(list(set([
        ...
        '东海', '东吴', '浦银安盛', '信达澳亚', '中加', '中航', '中融', '中���', '中庚', '中信保诚', '中信建投',
...
# 通过网盘分享的文件：XLSTM+informer.zip
# 链接: https://pan.baidu.com/s/1OltQCGtT-OiDEOCbJeLiXA 提取码: vfua 复制这段内容后打开百度网盘手机App，操作更方便哦
