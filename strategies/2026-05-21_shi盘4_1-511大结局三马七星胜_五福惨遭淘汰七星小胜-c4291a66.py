...
# title: shi盘4.1-511大结局三马七星胜！五福惨遭淘汰七星小胜
...
import jqmt8
# #策略倍率，配置QMT端倍率一起合作生效
# #主要用于运行多策略时 ，想单独控制某个策略资金
# #示例：策略资金：10000，策略倍率：2，QMT倍率：2
# # 推送到QMT时，变成20000，QMT再翻倍，最终生效：40000
jqmt8.rate = 1
...
def calculate_momentum_metrics_15(context, etf):
    try:
        lookback = max(g.lookback_days, g.short_lookback_days, g.rsi_period + 5) + 20
