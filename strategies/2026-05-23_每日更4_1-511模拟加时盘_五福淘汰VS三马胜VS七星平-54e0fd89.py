...
# title: 每日更4.1-511模拟加时盘：五福淘汰VS三马胜VS七星平
    ...
    try:
        ...
        if g.enable_low_point_rise_trigger:
            if rise_from_low >= g.low_point_rise_threshold:
                recovery_signals.append(f"从近{g.lookback_high_low_days}日��点上涨{rise_from_low:.2%}≥{g.low_point_rise_threshold:.0%}")
