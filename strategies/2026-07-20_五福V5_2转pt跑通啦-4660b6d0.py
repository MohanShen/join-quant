...
# backtestId: c6196147b3163c31f11ba119e43af71d
# title: 五福V5.2转pt跑通啦！
...
def check_a_share_weak_period(context):
    ...
    if g.is_a_share_weak:
        status_str += f" (已持续{g.weak_days_count}/{g.max_weak_days}个交易��)"
        record(走弱期状态=1)
    else:
        record(走弱期状态=0)
...
'''
# ** 五福闹新春 v5.2 - PTrade转换版 **
# 原代码：聚宽JQ v5.2（烟花三月ETF）
# 转换目标：100% PTrade API，保持JQ版本代码结构与逻辑
...
ETF_CODE_TO_NAME = {
    # === 全球/海外ETF池 ===
    '518880.SS': '黄金ETF', '501018.SS': '南方原油',
    '161226.SZ': '国投白银LOF', '159985.SZ': '豆粕ETF华夏', '159980.SZ': '有色ETF大成',
    '513310.SS': '中韩芯片', '159518.SZ': '标普油气ETF嘉实', '159509.SZ': '纳指科技ETF景顺',
    '513100.SS': '纳指ETF', '513520.SS': '日经ETF', '513500.SS': '标普500',
    '159502.SZ': '标普生物科技ETF嘉实', '513400.SS': '道琼斯',
    '513030.SS': '德国ETF', '513290.SS': '纳指生物', '520830.SS': '沙特ETF', '159529.SZ': '标普消费ETF景顺',
    # === 港股ETF ===
    '513090.SS': '香港证券', '513120.SS': 'HK创新药', '513180.SS': '恒指科技',
    '513330.SS': '恒生互联', '513750.SS': '港股非银', '159892.SZ': '恒生医药ETF华夏',
    '513190.SS': 'H股金融', '159605.SZ': '中概互联ETF广发', '513630.SS': '香港红利',
    '159323.SZ': '港股通汽车ETF华夏', '510900.SS': '恒生中国', '513920.SS': '央企40', '513970.SS': '恒生消费',
    # === 指数ETF ===
    '511380.SS': '转债ETF', '512050.SS': 'A500E', '510500.SS': '500ETF',
    '159915.SZ': '创业板ETF易方达', '510300.SS': '300ETF', '512100.SS': '1000ETF',
    '159949.SZ': '创业板50ETF华安', '588080.SS': '科创板50', '159967.SZ': '创业板成长ETF华夏',
    '588220.SS': '科创100F', '563300.SS': '中证2000', '510760.SS': '上证ETF',
    # === 行业ETF ===
    '588200.SS': '科创芯片', '515880.SS': '通信ETF', '159981.SZ': '能源化工ETF建信',
    '512880.SS': '证券ETF', '513350.SS': '油气ETF', '159326.SZ': '电网设备ETF华夏',
    '159516.SZ': '半导体设备ETF国泰', '159206.SZ': '卫星ETF永赢', '512480.SS': '半导体',
    '159363.SZ': '创业板人工智能ETF华宝', '159870.SZ': '化工ETF鹏华', '512400.SS': '有色ETF',
    '159755.SZ': '电池ETF广发', '588170.SS': '科创半导', '159992.SZ': '创新药ETF银华',
    '159995.SZ': '芯片ETF华夏', '512890.SS': '红利低波', '515220.SS': '煤炭ETF',
    '159566.SZ': '储能电池ETF易方达', '159819.SZ': '人工智能ETF易方达',
    '512800.SS': '银行ETF', '512690.SS': '酒ETF', '515050.SS': '5GETF',
    '562500.SS': '机器人', '512170.SS': '医疗ETF', '517520.SS': '黄金股',
    '159869.SZ': '游戏ETF华夏', '512070.SS': '证券保险', '159611.SZ': '电力ETF广发',
    '562800.SS': '稀有金属', '515120.SS': '创新药', '512010.SS': '医药ETF',
    '510880.SS': '红利ETF', '515790.SS': '光伏ETF', '515980.SS': '人工智能',
    '512660.SS': '军工ETF', '159928.SZ': '消费ETF汇添富', '512710.SS': '军工龙头',
    '560860.SS': '工业有色', '515030.SS': '新汽车', '159766.SZ': '旅游ETF富国',
    '159218.SZ': '卫星ETF招商', '159852.SZ': '软件ETF嘉实', '516160.SS': '新能源',
    '516150.SS': '稀土基金', '159227.SZ': '航空航天ETF华夏', '159583.SZ': '通信ETF富国',
    '588790.SS': '科创智能', '159865.SZ': '养殖ETF国泰', '512980.SS': '传媒ETF',
    '159851.SZ': '金融科技ETF华宝', '561360.SS': '石油ETF', '561980.SS': '芯片设备',
    '562590.SS': '半导材料', '512200.SS': '地产ETF', '159732.SZ': '消费电子ETF华夏',
    '159667.SZ': '工业母机ETF国泰', '516510.SS': '云计算', '159840.SZ': '锂电池ETF工银',
    '159998.SZ': '计算机ETF天弘', '159825.SZ': '农业ETF富国', '512670.SS': '国防ETF',
    '159883.SZ': '医疗器械ETF永赢', '515210.SS': '钢铁ETF', '515400.SS': '大数据',
    '159256.SZ': '创业板软件ETF华夏', '561330.SS': '矿业ETF', '515170.SS': '食品饮料',
    '159638.SZ': '高端装备ETF嘉实', '516520.SS': '智能驾驶', '513360.SS': '教育ETF', '516190.SS': '文娱ETF',
}


def _get_etf_name(security):
    """获取ETF名称"""
    if security in ETF_CODE_TO_NAME:
        return ETF_CODE_TO_NAME[security]
    try:
        info = get_security_info(security)
        return getattr(info, 'display_name', '') or getattr(info, 'name', '') or security
    except:
        return security
...
def _get_realtime_price(security):
    ...
    if is_trade():
        ...
        if snap and snap.get(security):
            ...
            if px > 0:
                return px
    hist = get_history(1, frequency='1m', field=['close'], security_list=security, fq='pre', include=True)
...
def _get_realtime_high_limit(security):
    ...
    hist = get_history(1, frequency='1d', field=['high_limit'], security_list=security, fq='pre', include=True)
...
def _get_realtime_low_limit(security):
    ...
    hist = get_history(1, frequency='1d', field=['low_limit'], security_list=security, fq='pre', include=True)
    ...
    for i in range(0, len(stock_list), batch_size):
        ...
        try:
            hist = get_history(count, frequency=freq, field=fields,
                               security_list=batch, fq='pre', include=include, is_dict=True)
            for s in batch:
                if s not in hist:
                    continue
                data = hist[s]
                if isinstance(data, dict):
                    ...
                    out = {}
                    for f in fields:
                        if hasattr(data, 'dtype') and f in data.dtype.names:
                            out[f] = list(data[f])
                    result[s] = out
        except:
            pass
...
def initialize(context):
    ...
    set_backtest()
    print("★" * 80)
    print("【五福闹新春】v5.2-PT原生转换版")
    print(f"=== ETF池配置 ===")
    print(f"- 全球/海外ETF池: {len(g.global_etf_pool)}只")
    print(f"- 中国ETF池: {len(g.china_etf_pool)}只")
    print(f"- 固定池合计: {len(g.fixed_etf_pool)}只")
    print(f"=== 大A走弱期判定 ===")
    print(f"- MA均线周期: {g.weak_period_ma_lookback}日")
    print(f"- 进入条件: 至少3/4指数低于MA{g.weak_period_ma_lookback}")
    print(f"- 退出条件: 至少3/4指数站上MA{g.weak_period_ma_lookback}")
    print(f"- 最长持续: {g.max_weak_days}个交易日")
    print(f"=== 动量得分过滤 ===")
    print(f"- 周期: {g.lookback_days}天")
    print(f"- 得分阈值: [{g.min_score_threshold}, {g.max_score_threshold}]")
    print(f"- 调仓系数: {g.score_threshold_ratio}")
    print(f"=== 过滤条件 ===")
    print(f"- 正常期 R²过滤: {'启用' if g.enable_r2_filter else '禁用'} (阈值>{g.r2_threshold:.1f})")
    print(f"- 走弱期 均线过滤: {'启用' if g.enable_ma_filter else '禁用'} (MA{g.ma_lookback}×{g.ma_threshold})")
    print(f"- 通用 成交量过滤: {'启用' if g.enable_volume_check else '禁用'} (近{g.volume_lookback}日均量比<{g.volume_threshold:.1f})")
    print(f"- 通用 短期风控: {'启用' if g.enable_loss_filter else '禁用'} (近3日单日跌幅<{1-g.loss:.0%})")
    print(f"=== 止损机制 ===")
    print(f"- 分钟级固定比例止损: {'启用' if g.use_fixed_stop_loss else '禁用'} (成本价×{g.fixedStopLossThreshold:.0%})")
    print(f"=== 其他配置 ===")
    print(f"- 持仓数量: {g.holdings_num}只")
    print(f"- 防御ETF: {g.defensive_etf}")
    print(f"- 最小交易额: {g.min_money}元")
    print(f"- 动态池上限: 300只")
    print(f"- 流动性阈值除数: {g.global_threshold_divisor}")
    print("★" * 80)
    ...
    run_daily(context, sell_routine, time='13:11')
    run_daily(context, buy_routine, time='13:12')
    run_daily(context, reset_daily_flags, time='15:10')

    for hour in range(9, 15):
        for minute in range(0, 60):
            current_time = "%02d:%02d" % (hour, minute)
            if ('09:40' < current_time < '10:29') or ('10:40' < current_time < '11:30') or ('13:00' < current_time < '14:57'):
...
def set_params():
    # ==================== 全球/海外ETF池 ====================
    g.global_etf_pool = [
        '518880.SS', '501018.SS', '161226.SZ', '159985.SZ', '159980.SZ',
        '513310.SS', '159518.SZ', '159509.SZ', '513100.SS', '513520.SS',
        '513500.SS', '159502.SZ', '513400.SS', '513030.SS', '513290.SS',
        '520830.SS', '159529.SZ',
    ]
    # ==================== 中国ETF池 ====================
    g.china_etf_pool = [
        '513090.SS', '513120.SS', '513180.SS', '513330.SS', '513750.SS',
        '159892.SZ', '513190.SS', '159605.SZ', '513630.SS', '159323.SZ',
        '510900.SS', '513920.SS', '513970.SS',
        '511380.SS', '512050.SS', '510500.SS', '159915.SZ', '510300.SS',
        '512100.SS', '159949.SZ', '588080.SS', '159967.SZ', '588220.SS',
        '563300.SS', '510760.SS',
        '588200.SS', '515880.SS', '159981.SZ', '512880.SS', '513350.SS',
        '159326.SZ', '159516.SZ', '159206.SZ', '512480.SS', '159363.SZ',
        '159870.SZ', '512400.SS', '159755.SZ', '588170.SS', '159992.SZ',
        '159995.SZ', '512890.SS', '515220.SS', '159566.SZ', '159819.SZ',
        '512800.SS', '512690.SS', '515050.SS', '562500.SS', '512170.SS',
        '517520.SS', '159869.SZ', '512070.SS', '159611.SZ', '562800.SS',
        '515120.SS', '512010.SS', '510880.SS', '515790.SS', '515980.SS',
        '512660.SS', '159928.SZ', '512710.SS', '560860.SS', '515030.SS',
        '159766.SZ', '159218.SZ', '159852.SZ', '516160.SS', '516150.SS',
        '159227.SZ', '159583.SZ', '588790.SS', '159865.SZ', '512980.SS',
        '159851.SZ', '561360.SS', '561980.SS', '562590.SS', '512200.SS',
        '159732.SZ', '159667.SZ', '516510.SS', '159840.SZ', '159998.SZ',
        '159825.SZ', '512670.SS', '159883.SZ', '515210.SS', '515400.SS',
        '159256.SZ', '561330.SS', '515170.SS', '159638.SZ', '516520.SS',
        '513360.SS', '516190.SS',
    ]
    g.fixed_etf_pool = g.global_etf_pool + g.china_etf_pool
    ...
    g.ranked_etfs_result = []
    g.target_etfs_list = []
    g.global_threshold_divisor = 20000
    ...
    g.yesterday_close_cache = {}
    g.etf_names_dict = {}
    g.hold_cost = {}  # 自定义持仓成本追踪（修复PTrade cost_basis被重算问题）
...
def check_positions(context):
    for security in context.portfolio.positions:
        ...
        if position.amount > 0:
            security_name = _get_etf_name(security)
            current_price = _get_realtime_price(security)
            hold_cost = g.hold_cost.get(security, position.cost_basis)
            log.info(f"📊 【持仓检查】{security} {security_name}, 数量: {position.amount}, 成本: {hold_cost:.3f}, 当前价: {current_price:.3f}")
...
def monitor_drawdown(context):
    try:
        ...
        log.info(f"【回撤监控】计算异常: {e}")


def get_all_etf_list():
    """获取全市场ETF列表——PTrade版（修复：回测模式下使用get_trend_data获取全市场ETF）"""
    try:
        if is_trade():
            return get_etf_list()
        else:
            # 回测模式：从get_trend_data获取全市场标的，按代码前缀筛选ETF
            try:
                trend_codes = list(get_trend_data().keys())
                if trend_codes:
                    etfs = []
                    for code in trend_codes:
                        code_upper = str(code).upper()
                        bare = code_upper.replace('.XSHG', '').replace('.XSHE', '').replace('.SS', '').replace('.SZ', '').replace('.SH', '').strip()
                        # ETF代码特征：上海51/52/56/58开头，深圳159开头
...
def calculate_global_etf_threshold(context):
    ...
    try:
        ...
        if len(totals) < 1:
            log.info(f"仅有{len(totals)}个有效交易日，使用保守阈值1000万")
            g.avg_etf_money_threshold = 10000000
            return
        idx = max(0, len(totals) - 3)
        recent_totals = totals[idx:]
        for i, m in enumerate(recent_totals):
            log.info(f"  近第{len(recent_totals)-i}日全市场ETF总成交额: {m/1e8:.2f}亿元")
        avg_total_money = sum(recent_totals) / len(recent_totals)
        threshold = avg_total_money / g.global_threshold_divisor
        g.avg_etf_money_threshold = threshold
        log.info(f"【全局阈值更新完成】近{len(recent_totals)}日全市场ETF日均总成交额={avg_total_money/1e8:.2f}亿元，阈值={threshold/1e4:.0f}万元（除数={g.global_threshold_divisor}）")
    except Exception as e:
        log.info(f"计算全局阈值异常: {e}，使用保守阈值1000万")
        g.avg_etf_money_threshold = 10000000
...
def filter_global_pool_by_volume(context):
    ...
    try:
        ...
        if not hist_data:
            log.info("【全球池过滤】无法获取成交额数据，使用原始全球池")
            g.filtered_global_pool = g.global_etf_pool[:]
            return
        avg_money_map = {}
        for s, d in hist_data.items():
...
def update_sector_pool(context):
    ...
    FUND_COMPANIES = sorted(list(set([
        ...
        '汇添富', '国泰', '平安', '银华', '天弘', '建信', '工银', '华泰柏瑞', '博时',
        '景顺长城', '景顺', '华宝', '申万菱信', '万家', '中欧', '兴证全球', '浙商',
        '诺安', '前海开源', '泰康', '泰达宏利', '农银汇理', '交银', '东方红', '财通',
        '华商', '国联', '永赢', '金鹰', '德邦', '创金合信', '西部利得', '圆信永丰',
        '泓德', '汇安', '诺德', '恒生前海', '华润元大', '大成', '海富通', '摩根',
        '华泰', '中信', '中银', '兴全', '国信', '长城', '中金', '浙商证券',
    ...
    all_etf_codes = get_all_etf_list()
    ...
    for code in all_etf_codes:
        if code not in g.etf_names_dict:
            g.etf_names_dict[code] = _get_etf_name(code)
    ...
    for code in special_etfs:
        ...
        group_counts[group_name] = group_counts.get(group_name, 0) + 1
    log.info(f"【动态池更新】特别组分布: {group_counts}")
    log.info(f"【动态池更新】进入特别组: {len(special_etfs)}只, 普通组: {len(normal_etfs)}只")
    log.info(f"【动态池更新】排除ETF: {excluded_count}只")
    ...
    top_300 = final_pool_info_sorted[:300]
    g.dynamic_etf_pool = [item['code'] for item in top_300]
    log.info(f"【动态池更新完成】动态池共{len(g.dynamic_etf_pool)}只ETF (上限300只)")
    if len(g.dynamic_etf_pool) > 0:
        for item in top_300[:3]:
            log.info(f"  {item['code']} {item['original_name']} 日均成交额: {item['money']/1e8:.2f}亿")
...
def filter_fixed_pool_by_volume(context):
    ...
    try:
        ...
        if not hist_data:
            log.info("【固定池过滤】无法获取成交额数据，使用原始固定池")
            g.filtered_fixed_pool = g.fixed_etf_pool[:]
            return
        avg_money_map = {}
        for s, d in hist_data.items():
    ...
    try:
        if is_trade():
            if _get_realtime_paused(security):
                return True
            return False
        minute_data = get_history(minute_count, frequency='1m', field=['volume'],
                                  security_list=security, fq='pre', include=True)
        if minute_data is None or minute_data.empty:
            return True
        if 'volume' in minute_data.columns:
            vols = minute_data['volume'].values
            if len(vols) > 0 and np.all(vols == 0):
                return True
        return False
    except:
        return False
...
def check_a_share_weak_period(context):
    ...
    below_count = 0
    for name, code in indexes.items():
        hist_data = get_history(g.weak_period_ma_lookback + 1, frequency='1d',
                                field=['close'], security_list=code, fq='pre', include=False)
        if hist_data is None or len(hist_data) < g.weak_period_ma_lookback:
            log.info(f"📊 【走弱期判断】{name}({code})数据不足，跳过")
            continue
        closes = hist_data['close'].values if 'close' in hist_data.columns else []
        if len(closes) < g.weak_period_ma_lookback:
            continue
...
def apply_filters(metrics_list):
    ...
    for name, condition, is_enabled in steps:
        if is_enabled:
            pre_len = len(filtered)
            filtered = [m for m in filtered if condition(m)]
            if len(filtered) < pre_len:
                log.info(f"  【过滤】{name}: {pre_len}→{len(filtered)}只通过")
    return filtered
...
def calculate_all_metrics_for_etf(etf, etf_name, hist_closes, hist_volumes, current_price, today_vol, context):
    try:
        ...
        return {
            ...
            'momentum_score': momentum_score, 'annualized_returns': annualized_returns,
            'r_squared': r_squared, 'current_price': current_price,
            'volume_ratio': volume_ratio, 'day_ratios': day_ratios,
            'passed_momentum': passed_momentum, 'passed_r2': passed_r2,
            'passed_ma': passed_ma,
            'passed_volume': volume_ratio is not None and volume_ratio < g.volume_threshold,
            'passed_loss': passed_loss_filter, 'ma_value': ma_value,
        }
    except:
        return None
...
def get_final_ranked_etfs(context):
    ...
    for etf in etf_set:
        try:
            if _get_realtime_paused(etf):
                ...
                continue
            if is_temporarily_suspended(etf, context):
                log.info(f"  {_get_etf_name(etf)} 盘中临时停牌，跳过计算")
                skipped_paused += 1
                continue
    ...
    if skipped_paused > 0 or skipped_data > 0:
        log.info(f"【动量计算】跳过: {skipped_paused}只停牌/临时停牌, {skipped_data}只数据不足")
    ...
    log_buffer = []
    log_buffer.append("")
    log_buffer.append(">>> 第一步：所有ETF动量得分排序（前100名）<<<")
    for m in all_metrics[:100]:
        score_str = f"{m['momentum_score']:.4f}" if m['momentum_score'] != float('-inf') else "nan"
        r2_str = f"{m['r_squared']:.3f}" if not pd.isna(m['r_squared']) else "nan"
        vol_val = f"{m['volume_ratio']:.2f}" if m['volume_ratio'] is not None else "N/A"
        ...
        loss_val = f"{min_ratio:.4f}" if isinstance(min_ratio, float) and not pd.isna(min_ratio) else str(min_ratio)
        ma_str = f"MA{g.ma_lookback}: {m['ma_value']:.2f}" if m['ma_value'] is not None else "MA:N/A"
        line = (f"{m['etf']} {m['etf_name']}: 动量得分: {score_str}{'✅' if m['passed_momentum'] else '❌'}, "
                f"R²: {r2_str}{'✅' if m['passed_r2'] else '❌'}, "
                f"量比: {vol_val}{'✅' if m['passed_volume'] else '❌'}, "
                f"风控: {loss_val}{'✅' if m['passed_loss'] else '❌'}")
        log_buffer.append(line)
    ...
    top_10 = filtered_list[:10]
    log_buffer.append("")
    log_buffer.append(">>> 第二步：符合全部过滤条件的ETF前10名 <<<")
    if top_10:
        for m in top_10:
            score_str = f"{m['momentum_score']:.4f}" if m['momentum_score'] != float('-inf') else "nan"
            r2_str = f"{m['r_squared']:.3f}" if not pd.isna(m['r_squared']) else "nan"
    ...
    if len(top_10) >= g.holdings_num:
        ...
        score_threshold = reference_score * ratio
        log_buffer.append("")
        log_buffer.append(f">>> 第三步：取动量得分≥第{g.holdings_num}名({top_10[g.holdings_num-1]['etf_name']})得分{reference_score:.4f}×{g.score_threshold_ratio}={score_threshold:.4f}的ETF <<<")
        candidate_pool = [item for item in top_10 if item.get(score_key, float('-inf')) >= score_threshold]
    else:
        log_buffer.append(f">>> 第三步：前10名不足{g.holdings_num}只，全部作为候选池 <<<")
        candidate_pool = top_10[:]
    log_buffer.append(f"【候选池】共{len(candidate_pool)}只ETF：")
    for i, item in enumerate(candidate_pool):
        log_buffer.append(f"  {i+1}. {item['etf_name']}({item['etf']}) {score_key}: {item.get(score_key, 0):.4f}")
    ...
    if len(retained) >= g.holdings_num:
        retained_sorted = sorted(retained, key=lambda x: x.get(score_key, float('-inf')), reverse=True)
        final_result = retained_sorted[:g.holdings_num]
        log_buffer.append(f"保留的持仓ETF数量({len(retained)})≥目标({g.holdings_num})，取前{g.holdings_num}只")
    else:
        need = g.holdings_num - len(retained)
        remaining_pool = [item for item in candidate_pool if item['etf'] not in {r['etf'] for r in retained}]
        additional = remaining_pool[:need]
...
def execute_sell_trades(context):
    ...
    if ranked_etfs:
        ...
        if check_defensive_etf_available(context):
            target_etfs = [g.defensive_etf]
            etf_name = _get_etf_name(g.defensive_etf)
            log.info(f"🛡️ 确定最终目标(防御模式): {g.defensive_etf} {etf_name}")
        else:
            log.info("💤 无最终目标(空仓模式)")
            target_etfs = []
...
def execute_buy_trades(context):
    ...
    # 只统计 amount > 0 的真实持仓（卖出中的仓位不计入）
    current_holdings = [sec for sec, pos in context.portfolio.positions.items() if pos.amount > 0]
    current_holdings_set = set(current_holdings)
    etfs_to_buy = [etf for etf in target_etfs if etf not in current_holdings_set]
    actual_holding_count = len(current_holdings)
    max_buy_count = max(0, g.holdings_num - actual_holding_count)
    num_etfs_to_buy = min(len(etfs_to_buy), max_buy_count)
    ...
    for i, etf in enumerate(etfs_to_buy):
        ...
        if target_value_for_this_etf < g.min_money and remaining_cash >= g.min_money:
            target_value_for_this_etf = remaining_cash
        # 留出手续费缓冲(0.2%)，防止PTrade因佣金扣减导致"资金不足"反复调整下单量
        target_value_for_this_etf = target_value_for_this_etf * 0.998
        log.info(f"为 {etf} 分配目标金额: {target_value_for_this_etf:.2f} 元 (剩余现金 {remaining_cash:.2f}, 待买数量 {remaining_to_buy})")
        success = smart_order_target_value(etf, target_value_for_this_etf, context)
        if success:
            log.info(f"✅ ETF {etf} 下单成功")
...
def smart_order_target_value(security, target_value, context):
    ...
    # ========== 1. 全天停牌检测 ==========
    if _get_realtime_paused(security):
        log.info(f"{security} {security_name} 全天停牌，跳过交易")
        return False
    # ========== 2. 盘中临时停牌检测 ==========
    if is_temporarily_suspended(security, context):
        log.info(f"{security} {security_name} 盘中临时停牌，跳过交易")
        return False
    ...
    trade_val = abs(diff) * current_price
    if 0 < trade_val < g.min_money:
        log.info(f"{security} {security_name} 交易金额{trade_val:.2f} < {g.min_money}，跳过")
        return False
    ...
    # ========== 7. 执行下单，自定义hold_cost追踪（修复PTrade cost_basis被重算） ==========
    if diff != 0:
        order_result = order(security, diff)
        if order_result:
            if diff > 0:
                # 买入：记录/更新持仓成本
                old_shares = cur_amount
                old_cost_value = g.hold_cost.get(security, 0) * old_shares
                new_shares = abs(diff)
                new_cost_value = current_price * new_shares
                total_shares = old_shares + new_shares
                if total_shares > 0:
                    g.hold_cost[security] = (old_cost_value + new_cost_value) / total_shares
                else:
                    g.hold_cost[security] = current_price
                log.info(f"📥 买入 {security} {security_name} 数量{new_shares} 价格{current_price:.3f} (hold_cost={g.hold_cost[security]:.3f})")
            else:
                # 卖出：清除持仓成本记录
                sell_qty = abs(diff)
                old_shares = cur_amount
                remaining = old_shares - sell_qty
                if remaining <= 0:
                    g.hold_cost.pop(security, None)
                log.info(f"📤 卖出 {security} {security_name} 数量{sell_qty} 价格{current_price:.3f}")
            return True
        else:
            log.info(f"下单失败: {security} {security_name}，数量{diff}")
            return False
    return False
...
def minute_level_stop_loss(context):
    ...
    for security in list(context.portfolio.positions.keys()):
        ...
        if current_price <= 0:
            continue
        # 使用自定义hold_cost（避免PTrade回测中cost_basis被重算导致误止损）
        cost_price = g.hold_cost.get(security, position.cost_basis)
        if cost_price <= 0:
            continue
        if current_price <= cost_price * g.fixedStopLossThreshold:
            security_name = _get_etf_name(security)
...
def check_defensive_etf_available(context):
    ...
    if last_price <= 0:
        log.info(f"防御性ETF {defensive_etf} 价格无效")
        return False
