...
# backtestId: 5a24840b0d7d2a37ba2eb139da1204dc
# title: 大道无形我无道
...
#行业ETF：
    ...
    g.laplace_s_param = 0.08             # 拉普拉斯衰减率
    g.laplace_min_slope = 0.0015         # 拉普拉斯斜率阈值
    g.gaussian_sigma = 0.9               # 高斯标准差
    g.gaussian_min_slope = 0.0015        # 高斯模式专用斜率阈值
    ...
    run_daily(afternoon_routine, time='14:30')    # 午后交易流水线（13:10）
...
def update_sector_pool(context):
    ...
    FUND_COMPANIES = sorted(list(set([
        ...
        '东海', '东吴', '浦银安盛', '信达澳亚', '中加', '中航', '中融', '中邮', '中庚', '��信保诚', '中信建投',
