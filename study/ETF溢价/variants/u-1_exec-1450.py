...
def initialize(context):
    ...
    run_daily(market_exec, '14:50', reference_security='000300.XSHG')  # u-1: execute at 14:50
...
def market_open(context):
    ...
    g.order_fund = order_fund  # u-1: signal fixed at 09:30 (open), executed at 14:50

def market_exec(context):
    order_fund = g.order_fund
    g.max_position = len(order_fund)
    # 卖出
