...
# ---
# study base snapshot — family: ETF溢价
# base archetype = 15c36e0c (minimal pure discount-reversion ETF rotation).
# Frozen harness cost OVERRIDE appended below (harness.md §2), matching strategy-normalize.js.
