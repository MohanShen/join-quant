...
# title: 低换手红利策略
# ---
# variant q-6 of study base snapshot — family: 红利低频
...
def initialize(context):
    ...
    g.phase = 12            # q-6: rebalance phase offset (first day still rebalances)
...
def check_rebalance(context):
    ...
    g.day_count += 1
    if (g.day_count + g.phase) % g.rebalance_days == 1 or g.day_count == 1:
        rebalance(context)
