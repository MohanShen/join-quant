...
# title: 低换手红利策略
# ---
# variant q-3 of study base snapshot — family: 红利低频
...
def get_stock_pool(context):
    ...
    # q-3: restrict to CSI800 constituents (size confound)
    csi800 = set(get_index_stocks('000906.XSHG', date=curr_date))
    stock_list = [s for s in stock_list if s in csi800]
