...
def set_params(context):
    ...
    # ========== [配置] 资金分配比例 ==========
    # 格式: [策略1比例, 策略2比例]
    g.portfolio_value_proportion = [1, 0]  # STUDY q-1: pure 策略1 小市值 (ablate 50% 策略2 ETF轮动 sleeve)

    # ========== [配置] 策略1空仓期资金动态分配 ==========
    g.enable_dynamic_proportion = False  # STUDY q-1: disable dynamic realloc so 策略2 never funded
