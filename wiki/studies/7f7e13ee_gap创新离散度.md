...
# 解剖报告：7f7e13ee_gap创新离散度（DQ — 为什么不行）

## 一句话结论
ETF/七星-五福-三马 动量轮动家族成员。normalize train **Sharpe 1.07 → DQ**（不达 2.5 门槛）。属 [[ETF轮动]] 动量轮动家族典型 regime-dependent DQ。
...
## 机理与真实性
归因基于 normalize train 指标（Sharpe 1.07）+ 家族已确立机理；未独立重跑（清晰家族迁移，节省预算）。confidence=med。
