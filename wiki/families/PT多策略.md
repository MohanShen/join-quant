...
|---|---|---|---|---|---|---|---|---|
| （band 50M-100M） | understand | universe 成交额 band 5M-20M→50M-100M（真流动基金） | study-q-1 | −3.5420 (→0.0535, DQ) | −17.08 (→1.09) | +11.60 (→21.15) | informative | 移到流动基金 edge **崩塌到 DQ**——头条纯薄基金 illiquidity 溢价，折价信号在流动基金上无风险调整 edge。⚠零滑点高估 |
| （nocap >5M） | understand | 去掉 20M 上界，保留 5M 下界（纳入流动基金） | study-q-1 | −0.7058 (→2.8897) | −4.80 (→13.37) | +4.39 (→13.94) | informative | 仅纳入流动基金即稀释——它们偶尔挤掉 top-10 里的薄名字；alpha 专属最不流动尾部，band 越贴薄基金头条越高。⚠零滑点高估 |
