...
# expId:            jul12-005
# ideaId:           idea-4  (仓位旋钮 g.target_count 5->6 扫描峰值)
# baseExpId:        jul12-000  (baseline 低开小市值剥头皮; source [[7a1c225f_小市值低开优化]])
# train_objective:  1.3898   (TRAIN 2022-01-01..2023-12-31: annual 150.51% / maxdd 11.53% / sharpe 5.96)
# val_objective:    1.3231   (VAL   2024-01-01..2024-12-31: annual 147.00% / maxdd 14.69% / sharpe 5.81)
# sharpe_val:       5.81
...
# expId:    jul12-005  (idea-4 sub-variant = jul12-000 + g.target_count 5->6)
# baseExpId: jul12-000
...
# mutation: 单一仓位旋钮 g.target_count 5->6; 资金分配自动缩放.
# note:     baseline TRAIN objective≈1.3738 / sharpe≈5.81.
#           ⚠ 低开剥头皮=高换手, 零滑点下 objective 偏高估 (harness §2).
