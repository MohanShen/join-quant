...
# expId:    jul12-015  (idea-12 Arc-2 = jul12-013 + 风控·止损线 -15% 日度检查)
# baseExpId: jul12-013  (min-cap 周度轮动 baseline; TRAIN score 0.2059, sharpe 1.65 DQ, maxdd 25.4%)
# harness:  research/harness.md (冻结成本 OVERRIDE 见文末; 迭代只跑 --window train)
# design:   min-cap 周度轮动 + 风控·个股止损: 每日 14:50 检查持仓, ret<=-15% 且非跌停 -> 清仓;
#           释放现金等下一次周度调仓再买 (无周中补仓). universe_size=400 -> hold_count=10 等权.
...
#           若 annual 亦崩(2022底部集体触发) 说明 25% 回撤是系统性 beta 而非个股特质.
