...
# expId:    jul12-018  (idea-15 NEW baseline Arc-3: 跨资产 ETF 20日动量轮动 top3)
# baseExpId: (none — fresh strategy, like jul12-013 was; NOT a mutation)
# harness:  research/harness.md (冻结成本 OVERRIDE 见文末; 迭代只跑 --window train)
# design:   ~13 只流动跨资产 ETF 池 -> 每只 20 日动量 close[-1]/close[-21]-1 -> 降序取 top3 等权;
#           run_weekly(weekday=1, open). 无择时/防御(始终持 top3, 切债/现金为未来变异).
