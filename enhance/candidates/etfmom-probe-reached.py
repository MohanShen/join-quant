...
# ===== REACHABILITY PROBE =====
# If this block executes, the strategy CANNOT run. A completed run proves the appended
# tail (and therefore the frozen OVERRIDE, which sits in the same region) never executes.
raise Exception("PROBE-REACHED: appended tail executed")
# ===== END REACHABILITY PROBE =====
