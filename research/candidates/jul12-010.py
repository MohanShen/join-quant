...
# expId:    jul12-010  (idea-7 = jul12-005 + 尾盘清仓阈值 last_price<open -> <open*0.99)
...
# mutation: 风控·退出阈值 单因子: sell() 11:30 破位清仓 last_price<today_open -> <today_open*0.99
#           (给-1%内的浮亏者一天喘息, 不当日清). 跌停不卖 guard 保持不变. 无池变化 -> runtime-safe.
# note:     bar to beat obj(TRAIN) > 1.3898. 松清仓 -> 0~1%浮亏者过夜, 观察 maxdd 是否上升(证伪路径).
