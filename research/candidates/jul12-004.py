...
# expId:    jul12-004  (idea-4 = jul12-000 + g.target_count 5->8)
# baseExpId: jul12-000
...
# mutation: 单一仓位旋钮 g.target_count 5->8; 所有资金分配(min_cash/preselect/needed/cash_per_stock)自动按其缩放.
...
def initialize(context):
    ...
    g.target_count = 8         # 目标持仓数量（最多同时持有8只股票）
