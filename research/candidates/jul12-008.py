...
# expId:    jul12-008  (idea-5 looser probe = jul12-005 + 振幅子阈值 amplitude>10 -> >12)
...
# mutation: 选股·技术量价 单因子: is_eligible_for_buy 近4日振幅上限 10% -> 12% (更宽的波动带).
# note:     bar to beat obj(TRAIN) > 1.3898; jul12-007 (>8, 更严) 已证明有害 obj=0.8291.
