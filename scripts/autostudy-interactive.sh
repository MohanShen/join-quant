...
# ── Remote Control preflight: RC to your phone routes through claude.ai. If the VPN/proxy
# blocks it, the session runs locally but won't appear on mobile — warn up front so it's not
# a silent surprise. (Non-blocking; the session still launches.)
